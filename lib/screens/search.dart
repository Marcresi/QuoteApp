...
class SearchFul extends StatefulWidget {
  const SearchFul({Key? key}) : super(key: key);

  @override
  State<SearchFul> createState() => _SearchState();
}

class _SearchState extends State<SearchFul> {
  Search? quotes3;
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Container(
                    ...
                    child: ListTile(
                      title: Text(
                        'Author : ${quotes3!.results[index].author}',
                        style: TextStyle(
                      ...
                      subtitle: Text(
                        'Quotes : ${quotes3!.results[index].content}',
                        style: TextStyle(
                      ...
                      trailing: IconButton(
                        ...
                        onPressed: () => context
                            .read<favouriteAdd>()
                            .favAdd(quotes3!.results[index].author),
                      ),
                    ),
                  );
                },
